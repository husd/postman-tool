...
public class TestHelper {
    ...
    private static EnhancedRandom enhancedRandom = EnhancedRandomBuilder.aNewEnhancedRandomBuilder()
            ...
            .randomize(String.class, (Randomizer<String>) () -> "1")
            .randomize(Short.class, (Randomizer<Short>) () -> (short) (Math.abs(anyInt(127))))
            .randomize(Character.class, (Randomizer<Character>) () -> 'A')
            .randomize(Long.class, (Randomizer<Long>) () -> TestHelper.anyLong(1000000))
            .randomize(BigDecimal.class, (Randomizer<BigDecimal>) () -> new BigDecimal("10.0"))
            .randomize(Integer.class, (Randomizer<Integer>) () -> TestHelper.anyInt(100))
    ...
    public static BigDecimal anyBigDecimal() {
        return BigDecimal.valueOf(anyDouble());
    }
